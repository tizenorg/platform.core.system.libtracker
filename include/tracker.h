...
typedef enum {
	TRACKER_TYPE_POWER_LOCK = 1 << 0, /**< Power Lock operation */
} tracker_type_e;
 ...
 * @param[in] types The operation type to start tracking information
 * @return  @c 0 on success,
 *          otherwise a negative error value
 * @retval  #TRACKER_ERROR_NONE Successful
 * @retval  #TRACKER_ERROR_INVALID_PARAMETER The input parameter is invalid
 * @retval  #TRACKER_ERROR_PERMISSION_DENIED No permission to use the API
 */
int tracker_start_services_internal(int services, int types);
 ...
 * @param[in] types The operation type to stop tracking information
 * @return  @c 0 on success,
 *          otherwise a negative error value
 * @retval  #TRACKER_ERROR_NONE Successful
 * @retval  #TRACKER_ERROR_INVALID_PARAMETER The input parameter is invalid
 * @retval  #TRACKER_ERROR_PERMISSION_DENIED No permission to use the API
 */
int tracker_stop_services_internal(int services, int types);
